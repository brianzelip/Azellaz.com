/*
  this file contains code used for programatically updating the app with new
  product metadata and images based on Abbie's insights from using Craftybase.com for
  inventory control, during July 2017.
*/
...
/*
  the below section of code was used for a major transition to the new products.json data file
*/
...
/*
  a real quick ditty for pretty formatting
*/
// const products = require("./products.json");
//
// fs.writeFile('_products.json', JSON.stringify(products, null, 2), (err) => {
//   if (err) throw err;
//   console.log('_products.json has been saved in a pretty way!');
// });


/*
  write all new product pages
*/

const products = require("./products.json");

function writeProductPage(product) {
  const fileName = `pages/${product.slug}.html`
...
products.map( (product) => writeProductPage(product) );
